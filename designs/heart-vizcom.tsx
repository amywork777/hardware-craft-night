...
const heartOutline = [
  ...
  { x: 4.00, y: -15.50 },
  // Fillet: bail to right lobe (2mm radius, curves outward)
  { x: 4.10, y: -15.80 }, { x: 4.30, y: -16.05 },
  { x: 4.60, y: -16.20 }, { x: 5.00, y: -16.25 },
  { x: 5.40, y: -16.20 }, { x: 5.80, y: -16.10 },
  { x: 6.30, y: -15.95 }, { x: 6.74, y: -15.88 }, { x: 9.24, y: -16.62 },
  ...
  // Fillet: left lobe to bail (2mm radius, curves outward)
  { x: -6.30, y: -15.95 }, { x: -5.80, y: -16.10 },
  { x: -5.40, y: -16.20 }, { x: -5.00, y: -16.25 },
  { x: -4.60, y: -16.20 }, { x: -4.30, y: -16.05 },
  { x: -4.10, y: -15.80 },
