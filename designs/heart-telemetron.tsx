...
import { TelemetronIcon, TelemetronText } from "./logos"
...
const heartOutline = [
  ...
  // Rounded bottom tip (~5mm radius)
  { x: 4.57, y: 16.69 }, { x: 3.2, y: 17.8 }, { x: 2.0, y: 18.6 },
  { x: 1.0, y: 19.0 }, { x: 0.0, y: 19.2 },
  { x: -1.0, y: 19.0 }, { x: -2.0, y: 18.6 },
  { x: -3.2, y: 17.8 }, { x: -4.57, y: 16.69 },
  // Left lobe
