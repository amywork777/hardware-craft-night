...
const heartOutline = [
  ...
  { x: 4.00, y: -15.50 }, { x: 4.00, y: -14.00 },
  // Fillet: bail to right lobe (~1.5mm radius)
  { x: 3.50, y: -13.02 }, { x: 3.60, y: -13.40 }, { x: 3.80, y: -13.70 },
  { x: 4.10, y: -14.00 }, { x: 4.30, y: -14.25 }, { x: 4.57, y: -14.62 }, { x: 6.74, y: -15.88 }, { x: 9.24, y: -16.62 },
  ...
  // Fillet: left lobe to bail (~1.5mm radius)
  { x: -4.57, y: -14.62 }, { x: -4.30, y: -14.25 }, { x: -4.10, y: -14.00 },
  { x: -3.80, y: -13.70 }, { x: -3.60, y: -13.40 }, { x: -3.50, y: -13.02 },
