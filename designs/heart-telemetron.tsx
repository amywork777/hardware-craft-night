...
const heartOutline = [
  ...
  { x: 4.00, y: -15.50 }, { x: 4.00, y: -14.50 },
  // Fillet: bail to right lobe (smooth S-curve, ~2mm min radius)
  { x: 3.90, y: -14.00 }, { x: 3.85, y: -13.60 },
  { x: 3.90, y: -13.30 }, { x: 4.05, y: -13.10 },
  { x: 4.25, y: -13.05 }, { x: 4.50, y: -13.20 },
  { x: 4.70, y: -13.60 }, { x: 4.80, y: -14.10 },
  ...
  // Fillet: left lobe to bail (smooth S-curve, ~2mm min radius)
  { x: -4.57, y: -14.62 }, { x: -4.80, y: -14.10 },
  { x: -4.70, y: -13.60 }, { x: -4.50, y: -13.20 },
  { x: -4.25, y: -13.05 }, { x: -4.05, y: -13.10 },
  { x: -3.90, y: -13.30 }, { x: -3.85, y: -13.60 },
  { x: -4.00, y: -14.50 },
