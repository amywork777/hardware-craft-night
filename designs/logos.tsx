...
export const VizcomLogoBig = ({ pcbX = 0, pcbY = 0 }: { pcbX?: number; pcbY?: number }) => (
  <>
    {/* V */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + -9.42, y: pcbY + 1.68 }, { x: pcbX + -10.8, y: pcbY + -1.73 },
      { x: pcbX + -9.47, y: pcbY + -1.73 }, { x: pcbX + -8.81, y: pcbY + 0.16 },
      { x: pcbX + -8.14, y: pcbY + -1.73 }, { x: pcbX + -6.86, y: pcbY + -1.73 },
      { x: pcbX + -8.24, y: pcbY + 1.68 }, { x: pcbX + -9.42, y: pcbY + 1.68 },
    ]} />
    {/* I */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + -5.39, y: pcbY + 1.68 }, { x: pcbX + -6.62, y: pcbY + 1.68 },
      { x: pcbX + -6.62, y: pcbY + -1.73 }, { x: pcbX + -5.39, y: pcbY + -1.73 },
      { x: pcbX + -5.39, y: pcbY + 1.68 },
    ]} />
    {/* Z */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + -1.93, y: pcbY + -1.73 }, { x: pcbX + -1.93, y: pcbY + -0.96 },
      { x: pcbX + -3.38, y: pcbY + 0.68 }, { x: pcbX + -1.91, y: pcbY + 0.68 },
      { x: pcbX + -1.91, y: pcbY + 1.68 }, { x: pcbX + -5.04, y: pcbY + 1.68 },
      { x: pcbX + -5.04, y: pcbY + 0.89 }, { x: pcbX + -3.58, y: pcbY + -0.73 },
      { x: pcbX + -4.95, y: pcbY + -0.73 }, { x: pcbX + -4.95, y: pcbY + -1.73 },
      { x: pcbX + -1.93, y: pcbY + -1.73 },
    ]} />
    {/* C */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + -1.8, y: pcbY + -0.04 }, { x: pcbX + -1.76, y: pcbY + -0.4 },
      { x: pcbX + -1.68, y: pcbY + -0.76 }, { x: pcbX + -1.51, y: pcbY + -1.06 },
      { x: pcbX + -1.28, y: pcbY + -1.31 }, { x: pcbX + -1.01, y: pcbY + -1.53 },
      { x: pcbX + -0.71, y: pcbY + -1.69 }, { x: pcbX + -0.35, y: pcbY + -1.8 },
      { x: pcbX + 0.05, y: pcbY + -1.84 }, { x: pcbX + 0.36, y: pcbY + -1.8 },
      { x: pcbX + 0.66, y: pcbY + -1.73 }, { x: pcbX + 0.84, y: pcbY + -1.66 },
      { x: pcbX + 0.84, y: pcbY + -0.52 }, { x: pcbX + 0.63, y: pcbY + -0.63 },
      { x: pcbX + 0.4, y: pcbY + -0.71 }, { x: pcbX + 0.23, y: pcbY + -0.71 },
      { x: pcbX + -0.07, y: pcbY + -0.66 }, { x: pcbX + -0.31, y: pcbY + -0.52 },
      { x: pcbX + -0.47, y: pcbY + -0.31 }, { x: pcbX + -0.54, y: pcbY + -0.04 },
      { x: pcbX + -0.47, y: pcbY + 0.25 }, { x: pcbX + -0.32, y: pcbY + 0.47 },
      { x: pcbX + -0.07, y: pcbY + 0.61 }, { x: pcbX + 0.23, y: pcbY + 0.65 },
      { x: pcbX + 0.4, y: pcbY + 0.65 }, { x: pcbX + 0.63, y: pcbY + 0.58 },
      { x: pcbX + 0.84, y: pcbY + 0.45 }, { x: pcbX + 0.84, y: pcbY + 1.58 },
      { x: pcbX + 0.54, y: pcbY + 1.71 }, { x: pcbX + 0.23, y: pcbY + 1.76 },
      { x: pcbX + 0.04, y: pcbY + 1.76 }, { x: pcbX + -0.35, y: pcbY + 1.74 },
      { x: pcbX + -0.71, y: pcbY + 1.64 }, { x: pcbX + -1.01, y: pcbY + 1.49 },
      { x: pcbX + -1.28, y: pcbY + 1.28 }, { x: pcbX + -1.49, y: pcbY + 1.02 },
      { x: pcbX + -1.66, y: pcbY + 0.72 }, { x: pcbX + -1.76, y: pcbY + 0.36 },
      { x: pcbX + -1.8, y: pcbY + -0.04 },
    ]} />
    {/* O outer */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + 2.99, y: pcbY + -1.84 }, { x: pcbX + 3.37, y: pcbY + -1.8 },
      { x: pcbX + 3.72, y: pcbY + -1.69 }, { x: pcbX + 4.05, y: pcbY + -1.53 },
      { x: pcbX + 4.33, y: pcbY + -1.31 }, { x: pcbX + 4.57, y: pcbY + -1.04 },
      { x: pcbX + 4.73, y: pcbY + -0.73 }, { x: pcbX + 4.84, y: pcbY + -0.4 },
      { x: pcbX + 4.87, y: pcbY + -0.04 }, { x: pcbX + 4.84, y: pcbY + 0.35 },
      { x: pcbX + 4.73, y: pcbY + 0.68 }, { x: pcbX + 4.57, y: pcbY + 0.99 },
      { x: pcbX + 4.33, y: pcbY + 1.26 }, { x: pcbX + 4.05, y: pcbY + 1.48 },
      { x: pcbX + 3.72, y: pcbY + 1.64 }, { x: pcbX + 3.37, y: pcbY + 1.74 },
      { x: pcbX + 2.99, y: pcbY + 1.76 }, { x: pcbX + 2.59, y: pcbY + 1.74 },
      { x: pcbX + 2.23, y: pcbY + 1.64 }, { x: pcbX + 1.91, y: pcbY + 1.48 },
      { x: pcbX + 1.62, y: pcbY + 1.26 }, { x: pcbX + 1.38, y: pcbY + 0.99 },
      { x: pcbX + 1.22, y: pcbY + 0.68 }, { x: pcbX + 1.12, y: pcbY + 0.35 },
      { x: pcbX + 1.08, y: pcbY + -0.04 }, { x: pcbX + 1.12, y: pcbY + -0.4 },
      { x: pcbX + 1.22, y: pcbY + -0.73 }, { x: pcbX + 1.38, y: pcbY + -1.04 },
      { x: pcbX + 1.62, y: pcbY + -1.31 }, { x: pcbX + 1.91, y: pcbY + -1.53 },
      { x: pcbX + 2.23, y: pcbY + -1.69 }, { x: pcbX + 2.59, y: pcbY + -1.8 },
      { x: pcbX + 2.99, y: pcbY + -1.84 },
    ]} />
    {/* O inner */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + 2.99, y: pcbY + -0.71 }, { x: pcbX + 2.71, y: pcbY + -0.65 },
      { x: pcbX + 2.5, y: pcbY + -0.5 }, { x: pcbX + 2.36, y: pcbY + -0.29 },
      { x: pcbX + 2.3, y: pcbY + -0.04 }, { x: pcbX + 2.36, y: pcbY + 0.24 },
      { x: pcbX + 2.5, y: pcbY + 0.45 }, { x: pcbX + 2.71, y: pcbY + 0.6 },
      { x: pcbX + 2.99, y: pcbY + 0.65 }, { x: pcbX + 3.24, y: pcbY + 0.6 },
      { x: pcbX + 3.46, y: pcbY + 0.45 }, { x: pcbX + 3.6, y: pcbY + 0.24 },
      { x: pcbX + 3.65, y: pcbY + -0.04 }, { x: pcbX + 3.6, y: pcbY + -0.29 },
      { x: pcbX + 3.46, y: pcbY + -0.5 }, { x: pcbX + 3.24, y: pcbY + -0.65 },
      { x: pcbX + 2.99, y: pcbY + -0.71 },
    ]} />
    {/* M */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + 6.35, y: pcbY + -0.16 }, { x: pcbX + 6.35, y: pcbY + 1.69 },
      { x: pcbX + 5.09, y: pcbY + 1.69 }, { x: pcbX + 5.09, y: pcbY + -1.73 },
      { x: pcbX + 6.35, y: pcbY + -1.73 }, { x: pcbX + 6.35, y: pcbY + -1.33 },
      { x: pcbX + 6.62, y: pcbY + -1.6 }, { x: pcbX + 6.98, y: pcbY + -1.78 },
      { x: pcbX + 7.29, y: pcbY + -1.81 }, { x: pcbX + 7.61, y: pcbY + -1.78 },
      { x: pcbX + 7.99, y: pcbY + -1.6 }, { x: pcbX + 8.26, y: pcbY + -1.27 },
      { x: pcbX + 8.58, y: pcbY + -1.62 }, { x: pcbX + 9.01, y: pcbY + -1.8 },
      { x: pcbX + 9.32, y: pcbY + -1.81 }, { x: pcbX + 9.84, y: pcbY + -1.73 },
      { x: pcbX + 10.22, y: pcbY + -1.46 }, { x: pcbX + 10.44, y: pcbY + -1.06 },
      { x: pcbX + 10.53, y: pcbY + -0.5 }, { x: pcbX + 10.53, y: pcbY + 1.69 },
      { x: pcbX + 9.27, y: pcbY + 1.69 }, { x: pcbX + 9.27, y: pcbY + -0.18 },
      { x: pcbX + 9.19, y: pcbY + -0.47 }, { x: pcbX + 9.04, y: pcbY + -0.65 },
      { x: pcbX + 8.86, y: pcbY + -0.68 }, { x: pcbX + 8.69, y: pcbY + -0.65 },
      { x: pcbX + 8.51, y: pcbY + -0.47 }, { x: pcbX + 8.45, y: pcbY + -0.16 },
      { x: pcbX + 8.45, y: pcbY + 1.69 }, { x: pcbX + 7.19, y: pcbY + 1.69 },
      { x: pcbX + 7.19, y: pcbY + -0.18 }, { x: pcbX + 7.13, y: pcbY + -0.47 },
      { x: pcbX + 6.95, y: pcbY + -0.65 }, { x: pcbX + 6.79, y: pcbY + -0.68 },
      { x: pcbX + 6.61, y: pcbY + -0.65 }, { x: pcbX + 6.42, y: pcbY + -0.47 },
      { x: pcbX + 6.35, y: pcbY + -0.16 },
    ]} />
  </>
)
...
export const TelemetronIconBig = ({ pcbX = 0, pcbY = 0 }: { pcbX?: number; pcbY?: number }) => (
  <>
    {/* Square 1 */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + -3.15, y: pcbY + 3.15 }, { x: pcbX + 0, y: pcbY + 3.15 },
      { x: pcbX + 0, y: pcbY + 0 }, { x: pcbX + -3.15, y: pcbY + 0 },
      { x: pcbX + -3.15, y: pcbY + 3.15 },
    ]} />
    {/* Square 2 */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + -1.56, y: pcbY + 1.56 }, { x: pcbX + 1.58, y: pcbY + 1.56 },
      { x: pcbX + 1.58, y: pcbY + -1.58 }, { x: pcbX + -1.56, y: pcbY + -1.58 },
      { x: pcbX + -1.56, y: pcbY + 1.56 },
    ]} />
    {/* Square 3 */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + 0, y: pcbY + 0 }, { x: pcbX + 3.15, y: pcbY + 0 },
    ...
    {/* Diagonal 1 */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + -1.56, y: pcbY + 1.56 }, { x: pcbX + 0, y: pcbY + 0 },
    ]} />
    {/* Diagonal 2 */}
    <silkscreenpath layer="bottom" route={[
      { x: pcbX + 0, y: pcbY + 0 }, { x: pcbX + 1.58, y: pcbY + -1.58 },
    ]} />
  </>
)
...
export const TelemetronTextBig = ({ pcbX = 0, pcbY = 0 }: { pcbX?: number; pcbY?: number }) => (
  <>
    {/* T */}
    <silkscreenpath layer="bottom" route={[{ x: pcbX + -4.7, y: pcbY + 0.79 }, { x: pcbX + -4.9, y: pcbY + 0.79 }, { x: pcbX + -4.9, y: pcbY + -0.63 }, { x: pcbX + -5.4, y: pcbY + -0.63 }, { x: pcbX + -5.4, y: pcbY + -0.81 }, { x: pcbX + -4.18, y: pcbY + -0.81 }, { x: pcbX + -4.18, y: pcbY + -0.63 }, { x: pcbX + -4.7, y: pcbY + -0.63 }, { x: pcbX + -4.7, y: pcbY + 0.79 }]} />
    {/* e1 */}
    <silkscreenpath layer="bottom" route={[{ x: pcbX + -3.53, y: pcbY + 0.81 }, { x: pcbX + -3.6, y: pcbY + 0.81 }, { x: pcbX + -3.67, y: pcbY + 0.79 }, { x: pcbX + -3.74, y: pcbY + 0.78 }, { x: pcbX + -3.8, y: pcbY + 0.73 }, { x: pcbX + -3.87, y: pcbY + 0.71 }, { x: pcbX + -3.91, y: pcbY + 0.65 }, { x: pcbX + -3.96, y: pcbY + 0.6 }, { x: pcbX + -4, y: pcbY + 0.54 }, { x: pcbX + -4.02, y: pcbY + 0.47 }, { x: pcbX + -4.03, y: pcbY + 0.4 }, { x: pcbX + -4.05, y: pcbY + 0.31 }, { x: pcbX + -4.05, y: pcbY + 0.22 }, { x: pcbX + -4.05, y: pcbY + 0.13 }, { x: pcbX + -4.03, y: pcbY + 0.06 }, { x: pcbX + -4.02, y: pcbY + -0.04 }, { x: pcbX + -4, y: pcbY + -0.11 }, { x: pcbX + -3.96, y: pcbY + -0.16 }, { x: pcbX + -3.91, y: pcbY + -0.22 }, { x: pcbX + -3.87, y: pcbY + -0.27 }, { x: pcbX + -3.82, y: pcbY + -0.31 }, { x: pcbX + -3.74, y: pcbY + -0.34 }, { x: pcbX + -3.67, y: pcbY + -0.37 }, { x: pcbX + -3.6, y: pcbY + -0.37 }, { x: pcbX + -3.53, y: pcbY + -0.4 }, { x: pcbX + -3.46, y: pcbY + -0.37 }, { x: pcbX + -3.38, y: pcbY + -0.37 }, { x: pcbX + -3.31, y: pcbY + -0.34 }, { x: pcbX + -3.26, y: pcbY + -0.32 }, { x: pcbX + -3.2, y: pcbY + -0.27 }, { x: pcbX + -3.15, y: pcbY + -0.23 }, { x: pcbX + -3.12, y: pcbY + -0.18 }, { x: pcbX + -3.08, y: pcbY + -0.11 }, { x: pcbX + -3.06, y: pcbY + -0.04 }, { x: pcbX + -3.04, y: pcbY + 0.04 }, { x: pcbX + -3.02, y: pcbY + 0.11 }, { x: pcbX + -3.02, y: pcbY + 0.2 }, { x: pcbX + -3.02, y: pcbY + 0.27 }, { x: pcbX + -3.96, y: pcbY + 0.27 }, { x: pcbX + -3.96, y: pcbY + 0.11 }, { x: pcbX + -3.12, y: pcbY + 0.11 }, { x: pcbX + -3.22, y: pcbY + 0.18 }, { x: pcbX + -3.22, y: pcbY + 0.11 }, { x: pcbX + -3.24, y: pcbY + 0 }, { x: pcbX + -3.28, y: pcbY + -0.09 }, { x: pcbX + -3.33, y: pcbY + -0.14 }, { x: pcbX + -3.4, y: pcbY + -0.2 }, { x: pcbX + -3.49, y: pcbY + -0.22 }, { x: pcbX + -3.53, y: pcbY + -0.22 }, { x: pcbX + -3.58, y: pcbY + -0.22 }, { x: pcbX + -3.65, y: pcbY + -0.2 }, { x: pcbX + -3.71, y: pcbY + -0.18 }, { x: pcbX + -3.77, y: pcbY + -0.11 }, { x: pcbX + -3.82, y: pcbY + -0.04 }, { x: pcbX + -3.85, y: pcbY + 0.06 }, { x: pcbX + -3.85, y: pcbY + 0.18 }, { x: pcbX + -3.85, y: pcbY + 0.31 }, { x: pcbX + -3.83, y: pcbY + 0.42 }, { x: pcbX + -3.8, y: pcbY + 0.5 }, { x: pcbX + -3.77, y: pcbY + 0.54 }, { x: pcbX + -3.69, y: pcbY + 0.6 }, { x: pcbX + -3.61, y: pcbY + 0.63 }, { x: pcbX + -3.51, y: pcbY + 0.65 }, { x: pcbX + -3.43, y: pcbY + 0.65 }, { x: pcbX + -3.38, y: pcbY + 0.63 }, { x: pcbX + -3.33, y: pcbY + 0.6 }, { x: pcbX + -3.3, y: pcbY + 0.56 }, { x: pcbX + -3.26, y: pcbY + 0.53 }, { x: pcbX + -3.22, y: pcbY + 0.47 }, { x: pcbX + -3.04, y: pcbY + 0.47 }, { x: pcbX + -3.06, y: pcbY + 0.54 }, { x: pcbX + -3.1, y: pcbY + 0.61 }, { x: pcbX + -3.13, y: pcbY + 0.67 }, { x: pcbX + -3.2, y: pcbY + 0.72 }, { x: pcbX + -3.26, y: pcbY + 0.76 }, { x: pcbX + -3.35, y: pcbY + 0.79 }, { x: pcbX + -3.42, y: pcbY + 0.81 }, { x: pcbX + -3.53, y: pcbY + 0.81 }]} />
    {/* l */}
    <silkscreenpath layer="bottom" route={[{ x: pcbX + -2.63, y: pcbY + 0.79 }, { x: pcbX + -2.81, y: pcbY + 0.79 }, { x: pcbX + -2.81, y: pcbY + -0.81 }, { x: pcbX + -2.63, y: pcbY + -0.81 }, { x: pcbX + -2.63, y: pcbY + 0.79 }]} />
    {/* e2 */}
    <silkscreenpath layer="bottom" route={[{ x: pcbX + -1.87, y: pcbY + 0.81 }, { x: pcbX + -1.97, y: pcbY + 0.81 }, { x: pcbX + -2.04, y: pcbY + 0.79 }, { x: pcbX + -2.11, y: pcbY + 0.78 }, { x: pcbX + -2.16, y: pcbY + 0.73 }, { x: pcbX + -2.22, y: pcbY + 0.71 }, { x: pcbX + -2.27, y: pcbY + 0.65 }, { x: pcbX + -2.33, y: pcbY + 0.6 }, { x: pcbX + -2.36, y: pcbY + 0.54 }, { x: pcbX + -2.38, y: pcbY + 0.47 }, { x: pcbX + -2.4, y: pcbY + 0.4 }, { x: pcbX + -2.41, y: pcbY + 0.31 }, { x: pcbX + -2.41, y: pcbY + 0.22 }, { x: pcbX + -2.41, y: pcbY + 0.13 }, { x: pcbX + -2.4, y: pcbY + 0.06 }, { x: pcbX + -2.38, y: pcbY + -0.04 }, { x: pcbX + -2.36, y: pcbY + -0.11 }, { x: pcbX + -2.33, y: pcbY + -0.16 }, { x: pcbX + -2.27, y: pcbY + -0.22 }, { x: pcbX + -2.23, y: pcbY + -0.27 }, { x: pcbX + -2.16, y: pcbY + -0.31 }, { x: pcbX + -2.11, y: pcbY + -0.34 }, { x: pcbX + -2.04, y: pcbY + -0.37 }, { x: pcbX + -1.97, y: pcbY + -0.37 }, { x: pcbX + -1.89, y: pcbY + -0.4 }, { x: pcbX + -1.82, y: pcbY + -0.37 }, { x: pcbX + -1.74, y: pcbY + -0.37 }, { x: pcbX + -1.68, y: pcbY + -0.34 }, { x: pcbX + -1.62, y: pcbY + -0.32 }, { x: pcbX + -1.56, y: pcbY + -0.27 }, { x: pcbX + -1.51, y: pcbY + -0.23 }, { x: pcbX + -1.48, y: pcbY + -0.18 }, { x: pcbX + -1.44, y: pcbY + -0.11 }, { x: pcbX + -1.43, y: pcbY + -0.04 }, { x: pcbX + -1.4, y: pcbY + 0.04 }, { x: pcbX + -1.39, y: pcbY + 0.11 }, { x: pcbX + -1.39, y: pcbY + 0.2 }, { x: pcbX + -1.39, y: pcbY + 0.27 }, { x: pcbX + -2.33, y: pcbY + 0.27 }, { x: pcbX + -2.33, y: pcbY + 0.11 }, { x: pcbX + -1.48, y: pcbY + 0.11 }, { x: pcbX + -1.56, y: pcbY + 0.18 }, { x: pcbX + -1.58, y: pcbY + 0.11 }, { x: pcbX + -1.61, y: pcbY + 0 }, { x: pcbX + -1.64, y: pcbY + -0.09 }, { x: pcbX + -1.69, y: pcbY + -0.14 }, { x: pcbX + -1.76, y: pcbY + -0.2 }, { x: pcbX + -1.86, y: pcbY + -0.22 }, { x: pcbX + -1.89, y: pcbY + -0.22 }, { x: pcbX + -1.94, y: pcbY + -0.22 }, { x: pcbX + -2.02, y: pcbY + -0.2 }, { x: pcbX + -2.09, y: pcbY + -0.14 }, { x: pcbX + -2.16, y: pcbY + -0.07 }, { x: pcbX + -2.2, y: pcbY + 0 }, { x: pcbX + -2.22, y: pcbY + 0.13 }, { x: pcbX + -2.22, y: pcbY + 0.18 }, { x: pcbX + -2.22, y: pcbY + 0.31 }, { x: pcbX + -2.2, y: pcbY + 0.42 }, { x: pcbX + -2.16, y: pcbY + 0.5 }, { x: pcbX + -2.12, y: pcbY + 0.54 }, { x: pcbX + -2.05, y: pcbY + 0.6 }, { x: pcbX + -1.98, y: pcbY + 0.63 }, { x: pcbX + -1.87, y: pcbY + 0.65 }, { x: pcbX + -1.8, y: pcbY + 0.65 }, { x: pcbX + -1.74, y: pcbY + 0.63 }, { x: pcbX + -1.69, y: pcbY + 0.6 }, { x: pcbX + -1.64, y: pcbY + 0.56 }, { x: pcbX + -1.62, y: pcbY + 0.53 }, { x: pcbX + -1.58, y: pcbY + 0.47 }, { x: pcbX + -1.39, y: pcbY + 0.47 }, { x: pcbX + -1.43, y: pcbY + 0.54 }, { x: pcbX + -1.46, y: pcbY + 0.61 }, { x: pcbX + -1.49, y: pcbY + 0.67 }, { x: pcbX + -1.55, y: pcbY + 0.72 }, { x: pcbX + -1.62, y: pcbY + 0.76 }, { x: pcbX + -1.71, y: pcbY + 0.79 }, { x: pcbX + -1.79, y: pcbY + 0.81 }, { x: pcbX + -1.87, y: pcbY + 0.81 }]} />
    {/* m */}
    <silkscreenpath layer="bottom" route={[{ x: pcbX + -0.99, y: pcbY + 0.79 }, { x: pcbX + -1.19, y: pcbY + 0.79 }, { x: pcbX + -1.19, y: pcbY + -0.36 }, { x: pcbX + -0.99, y: pcbY + -0.36 }, { x: pcbX + -0.99, y: pcbY + -0.2 }, { x: pcbX + -0.97, y: pcbY + -0.23 }, { x: pcbX + -0.94, y: pcbY + -0.27 }, { x: pcbX + -0.9, y: pcbY + -0.31 }, { x: pcbX + -0.86, y: pcbY + -0.34 }, { x: pcbX + -0.81, y: pcbY + -0.36 }, { x: pcbX + -0.78, y: pcbY + -0.37 }, { x: pcbX + -0.72, y: pcbY + -0.37 }, { x: pcbX + -0.67, y: pcbY + -0.4 }, { x: pcbX + -0.63, y: pcbY + -0.4 }, { x: pcbX + -0.6, y: pcbY + -0.37 }, { x: pcbX + -0.53, y: pcbY + -0.36 }, { x: pcbX + -0.47, y: pcbY + -0.32 }, { x: pcbX + -0.43, y: pcbY + -0.31 }, { x: pcbX + -0.4, y: pcbY + -0.27 }, { x: pcbX + -0.36, y: pcbY + -0.2 }, { x: pcbX + -0.35, y: pcbY + -0.16 }, { x: pcbX + -0.32, y: pcbY + -0.2 }, { x: pcbX + -0.27, y: pcbY + -0.25 }, { x: pcbX + -0.22, y: pcbY + -0.31 }, { x: pcbX + -0.16, y: pcbY + -0.34 }, { x: pcbX + -0.09, y: pcbY + -0.37 }, { x: pcbX + -0.02, y: pcbY + -0.4 }, { x: pcbX + 0.04, y: pcbY + -0.4 }, { x: pcbX + 0.09, y: pcbY + -0.37 }, { x: pcbX + 0.18, y: pcbY + -0.36 }, { x: pcbX + 0.27, y: pcbY + -0.32 }, { x: pcbX + 0.34, y: pcbY + -0.25 }, { x: pcbX + 0.37, y: pcbY + -0.16 }, { x: pcbX + 0.42, y: pcbY + -0.07 }, { x: pcbX + 0.42, y: pcbY + 0 }, { x: pcbX + 0.42, y: pcbY + 0.79 }, { x: pcbX + 0.22, y: pcbY + 0.79 }, { x: pcbX + 0.22, y: pcbY + 0.04 }, { x: pcbX + 0.2, y: pcbY + -0.04 }, { x: pcbX + 0.18, y: pcbY + -0.11 }, { x: pcbX + 0.14, y: pcbY + -0.14 }, { x: pcbX + 0.11, y: pcbY + -0.18 }, { x: pcbX + 0.04, y: pcbY + -0.22 }, { x: pcbX + -0.04, y: pcbY + -0.22 }, { x: pcbX + -0.11, y: pcbY + -0.22 }, { x: pcbX + -0.16, y: pcbY + -0.18 }, { x: pcbX + -0.22, y: pcbY + -0.14 }, { x: pcbX + -0.25, y: pcbY + -0.09 }, { x: pcbX + -0.29, y: pcbY + -0.01 }, { x: pcbX + -0.29, y: pcbY + 0.06 }, { x: pcbX + -0.29, y: pcbY + 0.79 }, { x: pcbX + -0.49, y: pcbY + 0.79 }, { x: pcbX + -0.49, y: pcbY + 0.02 }, { x: pcbX + -0.5, y: pcbY + -0.07 }, { x: pcbX + -0.54, y: pcbY + -0.12 }, { x: pcbX + -0.58, y: pcbY + -0.18 }, { x: pcbX + -0.63, y: pcbY + -0.2 }, { x: pcbX + -0.68, y: pcbY + -0.22 }, { x: pcbX + -0.72, y: pcbY + -0.22 }, { x: pcbX + -0.79, y: pcbY + -0.22 }, { x: pcbX + -0.86, y: pcbY + -0.18 }, { x: pcbX + -0.91, y: pcbY + -0.14 }, { x: pcbX + -0.96, y: pcbY + -0.07 }, { x: pcbX + -0.99, y: pcbY + -0.01 }, { x: pcbX + -0.99, y: pcbY + 0.07 }, { x: pcbX + -0.99, y: pcbY + 0.79 }]} />
    {/* e3 */}
    <silkscreenpath layer="bottom" route={[{ x: pcbX + 1.13, y: pcbY + 0.81 }, { x: pcbX + 1.06, y: pcbY + 0.81 }, { x: pcbX + 0.97, y: pcbY + 0.79 }, { x: pcbX + 0.91, y: pcbY + 0.78 }, { x: pcbX + 0.84, y: pcbY + 0.73 }, { x: pcbX + 0.79, y: pcbY + 0.71 }, { x: pcbX + 0.73, y: pcbY + 0.65 }, { x: pcbX + 0.71, y: pcbY + 0.6 }, { x: pcbX + 0.66, y: pcbY + 0.54 }, { x: pcbX + 0.63, y: pcbY + 0.47 }, { x: pcbX + 0.61, y: pcbY + 0.4 }, { x: pcbX + 0.59, y: pcbY + 0.31 }, { x: pcbX + 0.59, y: pcbY + 0.22 }, { x: pcbX + 0.59, y: pcbY + 0.13 }, { x: pcbX + 0.61, y: pcbY + 0.06 }, { x: pcbX + 0.63, y: pcbY + -0.04 }, { x: pcbX + 0.66, y: pcbY + -0.11 }, { x: pcbX + 0.71, y: pcbY + -0.16 }, { x: pcbX + 0.73, y: pcbY + -0.22 }, { x: pcbX + 0.79, y: pcbY + -0.27 }, { x: pcbX + 0.84, y: pcbY + -0.31 }, { x: pcbX + 0.9, y: pcbY + -0.34 }, { x: pcbX + 0.97, y: pcbY + -0.37 }, { x: pcbX + 1.04, y: pcbY + -0.37 }, { x: pcbX + 1.12, y: pcbY + -0.4 }, { x: pcbX + 1.2, y: pcbY + -0.37 }, { x: pcbX + 1.27, y: pcbY + -0.37 }, { x: pcbX + 1.33, y: pcbY + -0.34 }, { x: pcbX + 1.4, y: pcbY + -0.32 }, { x: pcbX + 1.46, y: pcbY + -0.27 }, { x: pcbX + 1.49, y: pcbY + -0.23 }, { x: pcbX + 1.53, y: pcbY + -0.18 }, { x: pcbX + 1.56, y: pcbY + -0.11 }, { x: pcbX + 1.6, y: pcbY + -0.04 }, { x: pcbX + 1.62, y: pcbY + 0.04 }, { x: pcbX + 1.63, y: pcbY + 0.11 }, { x: pcbX + 1.63, y: pcbY + 0.2 }, { x: pcbX + 1.63, y: pcbY + 0.27 }, { x: pcbX + 0.71, y: pcbY + 0.27 }, { x: pcbX + 0.71, y: pcbY + 0.11 }, { x: pcbX + 1.53, y: pcbY + 0.11 }, { x: pcbX + 1.44, y: pcbY + 0.18 }, { x: pcbX + 1.44, y: pcbY + 0.11 }, { x: pcbX + 1.42, y: pcbY + 0 }, { x: pcbX + 1.37, y: pcbY + -0.09 }, { x: pcbX + 1.31, y: pcbY + -0.14 }, { x: pcbX + 1.24, y: pcbY + -0.2 }, { x: pcbX + 1.17, y: pcbY + -0.22 }, { x: pcbX + 1.12, y: pcbY + -0.22 }, { x: pcbX + 1.08, y: pcbY + -0.22 }, { x: pcbX + 0.99, y: pcbY + -0.2 }, { x: pcbX + 0.91, y: pcbY + -0.14 }, { x: pcbX + 0.86, y: pcbY + -0.07 }, { x: pcbX + 0.83, y: pcbY + 0 }, { x: pcbX + 0.79, y: pcbY + 0.13 }, { x: pcbX + 0.79, y: pcbY + 0.18 }, { x: pcbX + 0.79, y: pcbY + 0.31 }, { x: pcbX + 0.81, y: pcbY + 0.42 }, { x: pcbX + 0.86, y: pcbY + 0.5 }, { x: pcbX + 0.89, y: pcbY + 0.54 }, { x: pcbX + 0.96, y: pcbY + 0.6 }, { x: pcbX + 0.99, y: pcbY + 0.61 }, { x: pcbX + 1.08, y: pcbY + 0.65 }, { x: pcbX + 1.13, y: pcbY + 0.65 }, { x: pcbX + 1.2, y: pcbY + 0.65 }, { x: pcbX + 1.27, y: pcbY + 0.63 }, { x: pcbX + 1.33, y: pcbY + 0.6 }, { x: pcbX + 1.37, y: pcbY + 0.56 }, { x: pcbX + 1.4, y: pcbY + 0.53 }, { x: pcbX + 1.42, y: pcbY + 0.47 }, { x: pcbX + 1.62, y: pcbY + 0.47 }, { x: pcbX + 1.6, y: pcbY + 0.54 }, { x: pcbX + 1.56, y: pcbY + 0.61 }, { x: pcbX + 1.51, y: pcbY + 0.67 }, { x: pcbX + 1.46, y: pcbY + 0.72 }, { x: pcbX + 1.38, y: pcbY + 0.76 }, { x: pcbX + 1.31, y: pcbY + 0.79 }, { x: pcbX + 1.22, y: pcbY + 0.81 }, { x: pcbX + 1.13, y: pcbY + 0.81 }]} />
    {/* t */}
    <silkscreenpath layer="bottom" route={[{ x: pcbX + 2.21, y: pcbY + 0.81 }, { x: pcbX + 2.12, y: pcbY + 0.81 }, { x: pcbX + 2.07, y: pcbY + 0.79 }, { x: pcbX + 2.02, y: pcbY + 0.78 }, { x: pcbX + 1.96, y: pcbY + 0.73 }, { x: pcbX + 1.92, y: pcbY + 0.71 }, { x: pcbX + 1.91, y: pcbY + 0.65 }, { x: pcbX + 1.89, y: pcbY + 0.58 }, { x: pcbX + 1.89, y: pcbY + 0.5 }, { x: pcbX + 1.89, y: pcbY + -0.2 }, { x: pcbX + 1.71, y: pcbY + -0.2 }, { x: pcbX + 1.71, y: pcbY + -0.36 }, { x: pcbX + 1.89, y: pcbY + -0.36 }, { x: pcbX + 1.89, y: pcbY + -0.68 }, { x: pcbX + 2.09, y: pcbY + -0.68 }, { x: pcbX + 2.09, y: pcbY + -0.36 }, { x: pcbX + 2.3, y: pcbY + -0.36 }, { x: pcbX + 2.3, y: pcbY + -0.2 }, { x: pcbX + 2.09, y: pcbY + -0.2 }, { x: pcbX + 2.09, y: pcbY + 0.5 }, { x: pcbX + 2.1, y: pcbY + 0.58 }, { x: pcbX + 2.12, y: pcbY + 0.63 }, { x: pcbX + 2.17, y: pcbY + 0.65 }, { x: pcbX + 2.21, y: pcbY + 0.65 }, { x: pcbX + 2.25, y: pcbY + 0.67 }, { x: pcbX + 2.3, y: pcbY + 0.65 }, { x: pcbX + 2.3, y: pcbY + 0.81 }, { x: pcbX + 2.28, y: pcbY + 0.81 }, { x: pcbX + 2.25, y: pcbY + 0.81 }, { x: pcbX + 2.21, y: pcbY + 0.81 }]} />
    {/* r */}
    <silkscreenpath layer="bottom" route={[{ x: pcbX + 2.71, y: pcbY + 0.79 }, { x: pcbX + 2.52, y: pcbY + 0.79 }, { x: pcbX + 2.52, y: pcbY + -0.36 }, { x: pcbX + 2.71, y: pcbY + -0.36 }, { x: pcbX + 2.71, y: pcbY + -0.16 }, { x: pcbX + 2.74, y: pcbY + -0.22 }, { x: pcbX + 2.79, y: pcbY + -0.31 }, { x: pcbX + 2.86, y: pcbY + -0.36 }, { x: pcbX + 2.93, y: pcbY + -0.37 }, { x: pcbX + 2.99, y: pcbY + -0.4 }, { x: pcbX + 3.02, y: pcbY + -0.4 }, { x: pcbX + 3.06, y: pcbY + -0.37 }, { x: pcbX + 3.06, y: pcbY + -0.2 }, { x: pcbX + 3.02, y: pcbY + -0.2 }, { x: pcbX + 2.99, y: pcbY + -0.2 }, { x: pcbX + 2.93, y: pcbY + -0.2 }, { x: pcbX + 2.86, y: pcbY + -0.18 }, { x: pcbX + 2.81, y: pcbY + -0.14 }, { x: pcbX + 2.75, y: pcbY + -0.11 }, { x: pcbX + 2.74, y: pcbY + -0.04 }, { x: pcbX + 2.71, y: pcbY + 0.04 }, { x: pcbX + 2.71, y: pcbY + 0.07 }, { x: pcbX + 2.71, y: pcbY + 0.79 }]} />
    {/* o */}
    <silkscreenpath layer="bottom" route={[{ x: pcbX + 3.71, y: pcbY + 0.81 }, { x: pcbX + 3.64, y: pcbY + 0.81 }, { x: pcbX + 3.56, y: pcbY + 0.79 }, { x: pcbX + 3.49, y: pcbY + 0.78 }, { x: pcbX + 3.42, y: pcbY + 0.73 }, { x: pcbX + 3.37, y: pcbY + 0.71 }, { x: pcbX + 3.31, y: pcbY + 0.65 }, { x: pcbX + 3.28, y: pcbY + 0.6 }, { x: pcbX + 3.24, y: pcbY + 0.54 }, { x: pcbX + 3.2, y: pcbY + 0.47 }, { x: pcbX + 3.18, y: pcbY + 0.38 }, { x: pcbX + 3.17, y: pcbY + 0.31 }, { x: pcbX + 3.17, y: pcbY + 0.22 }, { x: pcbX + 3.17, y: pcbY + 0.13 }, { x: pcbX + 3.18, y: pcbY + 0.04 }, { x: pcbX + 3.2, y: pcbY + -0.04 }, { x: pcbX + 3.24, y: pcbY + -0.11 }, { x: pcbX + 3.28, y: pcbY + -0.18 }, { x: pcbX + 3.31, y: pcbY + -0.23 }, { x: pcbX + 3.37, y: pcbY + -0.27 }, { x: pcbX + 3.42, y: pcbY + -0.32 }, { x: pcbX + 3.49, y: pcbY + -0.34 }, { x: pcbX + 3.56, y: pcbY + -0.37 }, { x: pcbX + 3.64, y: pcbY + -0.37 }, { x: pcbX + 3.71, y: pcbY + -0.4 }, { x: pcbX + 3.78, y: pcbY + -0.37 }, { x: pcbX + 3.85, y: pcbY + -0.37 }, { x: pcbX + 3.92, y: pcbY + -0.34 }, { x: pcbX + 4, y: pcbY + -0.32 }, { x: pcbX + 4.05, y: pcbY + -0.27 }, { x: pcbX + 4.1, y: pcbY + -0.23 }, { x: pcbX + 4.14, y: pcbY + -0.18 }, { x: pcbX + 4.18, y: pcbY + -0.11 }, { x: pcbX + 4.21, y: pcbY + -0.04 }, { x: pcbX + 4.23, y: pcbY + 0.04 }, { x: pcbX + 4.25, y: pcbY + 0.13 }, { x: pcbX + 4.25, y: pcbY + 0.22 }, { x: pcbX + 4.25, y: pcbY + 0.31 }, { x: pcbX + 4.23, y: pcbY + 0.4 }, { x: pcbX + 4.21, y: pcbY + 0.47 }, { x: pcbX + 4.18, y: pcbY + 0.54 }, { x: pcbX + 4.14, y: pcbY + 0.6 }, { x: pcbX + 4.1, y: pcbY + 0.65 }, { x: pcbX + 4.05, y: pcbY + 0.71 }, { x: pcbX + 4, y: pcbY + 0.73 }, { x: pcbX + 3.92, y: pcbY + 0.78 }, { x: pcbX + 3.85, y: pcbY + 0.79 }, { x: pcbX + 3.78, y: pcbY + 0.81 }, { x: pcbX + 3.71, y: pcbY + 0.81 }]} />
    {/* o inner */}
    <silkscreenpath layer="bottom" route={[{ x: pcbX + 3.71, y: pcbY + 0.65 }, { x: pcbX + 3.76, y: pcbY + 0.65 }, { x: pcbX + 3.85, y: pcbY + 0.61 }, { x: pcbX + 3.92, y: pcbY + 0.56 }, { x: pcbX + 3.97, y: pcbY + 0.49 }, { x: pcbX + 4.01, y: pcbY + 0.4 }, { x: pcbX + 4.05, y: pcbY + 0.29 }, { x: pcbX + 4.05, y: pcbY + 0.22 }, { x: pcbX + 4.05, y: pcbY + 0.14 }, { x: pcbX + 4.01, y: pcbY + 0.04 }, { x: pcbX + 3.97, y: pcbY + -0.07 }, { x: pcbX + 3.92, y: pcbY + -0.14 }, { x: pcbX + 3.85, y: pcbY + -0.2 }, { x: pcbX + 3.76, y: pcbY + -0.22 }, { x: pcbX + 3.71, y: pcbY + -0.22 }, { x: pcbX + 3.65, y: pcbY + -0.22 }, { x: pcbX + 3.56, y: pcbY + -0.18 }, { x: pcbX + 3.49, y: pcbY + -0.14 }, { x: pcbX + 3.43, y: pcbY + -0.07 }, { x: pcbX + 3.38, y: pcbY + 0.04 }, { x: pcbX + 3.37, y: pcbY + 0.14 }, { x: pcbX + 3.37, y: pcbY + 0.22 }, { x: pcbX + 3.37, y: pcbY + 0.29 }, { x: pcbX + 3.38, y: pcbY + 0.4 }, { x: pcbX + 3.43, y: pcbY + 0.49 }, { x: pcbX + 3.49, y: pcbY + 0.56 }, { x: pcbX + 3.56, y: pcbY + 0.61 }, { x: pcbX + 3.65, y: pcbY + 0.65 }, { x: pcbX + 3.71, y: pcbY + 0.65 }]} />
    {/* n */}
    <silkscreenpath layer="bottom" route={[{ x: pcbX + 4.62, y: pcbY + 0.79 }, { x: pcbX + 4.45, y: pcbY + 0.79 }, { x: pcbX + 4.45, y: pcbY + -0.36 }, { x: pcbX + 4.62, y: pcbY + -0.36 }, { x: pcbX + 4.62, y: pcbY + -0.2 }, { x: pcbX + 4.66, y: pcbY + -0.23 }, { x: pcbX + 4.73, y: pcbY + -0.31 }, { x: pcbX + 4.82, y: pcbY + -0.36 }, { x: pcbX + 4.93, y: pcbY + -0.37 }, { x: pcbX + 5, y: pcbY + -0.4 }, { x: pcbX + 5.09, y: pcbY + -0.37 }, { x: pcbX + 5.23, y: pcbY + -0.32 }, { x: pcbX + 5.35, y: pcbY + -0.22 }, { x: pcbX + 5.4, y: pcbY + -0.05 }, { x: pcbX + 5.4, y: pcbY + 0.04 }, { x: pcbX + 5.4, y: pcbY + 0.79 }, { x: pcbX + 5.2, y: pcbY + 0.79 }, { x: pcbX + 5.2, y: pcbY + 0.07 }, { x: pcbX + 5.18, y: pcbY + -0.05 }, { x: pcbX + 5.13, y: pcbY + -0.14 }, { x: pcbX + 5.05, y: pcbY + -0.2 }, { x: pcbX + 5, y: pcbY + -0.22 }, { x: pcbX + 4.93, y: pcbY + -0.22 }, { x: pcbX + 4.86, y: pcbY + -0.22 }, { x: pcbX + 4.77, y: pcbY + -0.18 }, { x: pcbX + 4.72, y: pcbY + -0.12 }, { x: pcbX + 4.68, y: pcbY + -0.05 }, { x: pcbX + 4.64, y: pcbY + 0.02 }, { x: pcbX + 4.62, y: pcbY + 0.11 }, { x: pcbX + 4.62, y: pcbY + 0.79 }]} />
  </>
)
